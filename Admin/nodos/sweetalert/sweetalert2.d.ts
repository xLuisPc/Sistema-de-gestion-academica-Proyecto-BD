declare module 'Admin/nodos/sweetalert/sweetalert2' {
  /**
...
declare module 'sweetalert2/*/sweetalert2.js' {
  export * from 'Admin/nodos/sweetalert/sweetalert2'
  // "export *" does not matches the default export, so do it explicitly.
  export { default } from 'Admin/nodos/sweetalert/sweetalert2' // eslint-disable-line
}
