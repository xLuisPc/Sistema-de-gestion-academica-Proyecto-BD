/**
 * @typedef { import('Admin/nodos/sweetalert/src/sweetalert2').default } SweetAlert2
 * @typedef { import('Admin/nodos/sweetalert/src/sweetalert2').SweetAlertOptions } SweetAlertOptions
 */
